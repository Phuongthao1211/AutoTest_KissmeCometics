...
WebUI.click(findTestObject('Page_Son Tint Romand Dewyful Water Tint 5g _9e0f82/GiamSoLuong'))
...
WebUI.click(findTestObject('Object Repository/Page_Gio hang Kissme Cosmetics/button_GiamSoLuongTrongGio'))
